...
public abstract class BaseTicketItem  implements Comparable, Serializable {
	...
	private java.util.List<com.floreantpos.model.TicketItemTax> taxes;
	...
	public java.util.List<com.floreantpos.model.TicketItemTax> getTaxes() {
		return taxes;
	}

	public void setTaxes(java.util.List<com.floreantpos.model.TicketItemTax> taxes) {
		this.taxes = taxes;
	}
