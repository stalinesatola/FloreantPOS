...
public class POSConstants {
	...
	public static final String TICKET_LIST_COLUMN_ROOM_NO = Messages.getString("TICKET_LIST_COLUMN_ROOM_NO"); //$NON-NLS-1$
	public static final String TICKET_LIST_COLUMN_PHONE_NO = Messages.getString("TICKET_LIST_COLUMN_PHONE_NO"); //$NON-NLS-1$
	...
	public static final String BILLING_REPORT = Messages.getString("BillingReport.1");
}
